    ...
    <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="page-header">
                        <form method="get" action='{{url("admin/ctdh/timkiem.html")}}'>
                            <input type="text"  placeholder="Tìm kiếm theo mã, tên, đơn giá, đơn hàng...." name="txtSearch" size="50">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-outline btn-default" href="{{url('admin/ctdh/danhsach.html')}}">Tải lại</a>
                </div>
            </div>
            <hr>
            <div class="row">
