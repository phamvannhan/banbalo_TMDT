            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form role="form" method="post" action='{{url("admin/sli/$sli->id/sua.html")}}' enctype="multipart/form-data">
                            {{csrf_field()}}
                           <div class="row">
                                <div class="col-lg-6">
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Href</label>
                                            <input class="form-control" id="href" type="text" name="href" value="{{$sli->href}}" placeholder="Nhập đường liên kết...">
                                        </div>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                        <div class="form-group">
                                        	...
                                        	<div class="form-group">
                                        		<img src="{{url($sli->anh)}}" alt="anh" class="img-thumbnail">
                                        	</div>
