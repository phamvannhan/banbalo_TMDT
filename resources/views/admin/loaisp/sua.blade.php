            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form role="form" method="post" action='{{url("admin/lsp/$loai->id/sua.html")}}'>
                            {{csrf_field()}}
                           <div class="row">
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Tên loại sản phẩm</label>
                                            <input class="form-control" type="text" name="ten" id="ten" value="{{$loai->ten}}" placeholder="Nhập tên loại sản phẩm...">
                                            <input type="hidden" name="slug" id="slug" value="{{$loai->slug}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Vị trí</label>
                                            <input class="form-control" type="text" name="vitri" id="vitri" value="{{$loai->vitri}}" placeholder="Nhập vị trí...">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    ...
                                                    @if(!empty($dscm))
                                                        @foreach($dscm as $cm)
                                                            @if($cm->id == $loai->id_cm)
                                                                <option value="{{$cm->id}}" selected="selected">{{$cm->ten}}</option>
                                                            @else
