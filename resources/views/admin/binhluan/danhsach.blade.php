...
<div class="row">
                ...
                <div class="col-lg-6">
                    <div class="page-header">
                        <form method="get" action='{{url("admin/bl/timkiem.html")}}'>
                            <input type="text"  placeholder="Tìm kiếm theo mã, tên sản phẩm, tên khách hàng...." name="txtSearch" size="50">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$bl->noidung}}</td>
                                        <td>{{$bl->created_at}}</td>
                                        <td><a class="btn btn-info btndetail" data-id="{{$bl->id}}" href='{{url("admin/bl/$bl->id/chitiet.html")}}'>Chi Tiết</a></td>
